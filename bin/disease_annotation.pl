...
=head1 SYNOPSIS
 ...
 Optional arguments:
        ...
        --addon                         the name of a user-defined add-on DB_GENE_DISEASE_SCORE file (has to be in the ./lib/compiled_database)
        --addon_gg                      the name of user-defined add-on DB_GENE_GENE_SCORE file (has to be in the ./lib/compiled_database)
