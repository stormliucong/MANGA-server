        ...
        if_json_success = false;
	         ...
	         if(if_json_success)
	        	 ...
	        	 $("#page-next").click(function(){
	        		 current_page = $("#page-number").val();change_page(++current_page); });  
	        	 $("#page-previous").click(function(){
	        		 current_page = $("#page-number").val();change_page(--current_page); });  
	        	 $("#page-go").click(function(){
	        		 current_page = $("#page-number").val();change_page(parseInt(current_page)); });  
	        	 
	        	 }//if(if_json_success)
	             for(var i=0;i<500 && i<json.length;i++)
	            	 {
	            	   var bar_modal = $('<div class="modal fade" id="gene'+i+'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">'
    +'<div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header">'
    +'<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>'
    +'<h4 class="modal-title text-primary" id="myModalLabel">'+json[i][0]+'</h4></div><div class="modal-body">'
    +json[i][1]
      +'</div><div class="modal-footer"><button type="button" class="btn btn-primary" data-dismiss="modal">Close</button></div></div></div></div>').insertAfter("#bar");
