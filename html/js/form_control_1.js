$(window).load(function() {
    ...
    $.when(
        ...
        disease_input.autocomplete({
            source: function(request, response) {
                ...
                if (terms.length >= 2) {
                    old_string = terms.splice(0, terms.length - 1).join("\n");
                    old_string += "\n";
                } else {
                    old_string = "";
                }
                var matcher = new RegExp("^" + $.ui.autocomplete.escapeRegex(term), "i");
                var list = $.grep(disease_count, function(item) {
    ...
    region_selection_label.tooltip({
        content: instruction,
        position: {
            my: "right bottom",
            at: "right top-10"
    ...
    advanced_options_label.tooltip({
        content: instruction,
        position: {
            my: "right bottom",
            at: "right top-5"
