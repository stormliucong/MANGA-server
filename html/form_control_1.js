  $(function(){
	            ...
	            //predefined functions
	              function GeneChange()
	              {
	                    ...
	                    {
	                    	 gene_selection_label.css("color","#3333cc");
	              ...
	              function RegionChange()
	              {
	 		            ...
	 		            {
	 	                	region_selection_label.css("color","#3333cc");
	             ...
	             $("label").each(function(){
                  ...
                  //The label click events
                    ...
                    function(){
                       ...
                       {	   
                            other_options.find("option:selected").removeAttr("selected");
                            other_options.find("option[value='all_diseases']").prop("selected","true");
                            AdvancedChange();
                       }
                       else if(disease_label.html()=="Diseases/Phenotypes")
                       {                  	   
                    	   other_options.find("option:selected").removeAttr("selected");
                    	   other_options.find("option[value='none']").prop("selected","true");
                           AdvancedChange();
                       }
                       ...
                       {
                    	   other_options.find("option:selected").removeAttr("selected");
                    	   other_options.find("option[value='phenotype_interpretation']").prop("selected","true");
                           AdvancedChange();
                       }
                    ...
                    function(){
                       if(gene_options.find("option:selected").val()=="no")
                    	   ...
                    	   gene_options.find("option:selected").removeAttr("selected");
                    	   gene_options.find("option[value='yes']").attr("selected","true");                   	  
                    	   }
                       else
                    	   {
                    	  
                    	   gene_options.find("option:selected").removeAttr("selected");
                    	   gene_options.find("option[value='no']").attr("selected","true");                    	     
                    	   }
                           GeneChange();
  	                    });
                   ...
                   function(){
                	   ...
                	   region_options.find("option:selected").removeAttr("selected");
                	   region_options.find("option[value='yes']").attr("selected","true");                   	  
                	   }
                   else
                	   {
                	   
                	   region_options.find("option:selected").removeAttr("selected");
                	   region_options.find("option[value='no']").attr("selected","true");                    	     
                	   }
                       RegionChange();
                   });
                   weight_label.click(
                           function(){
                              if(weight_options.find("option:selected").val()=="no")
                           	   ...
                           	   weight_options.find("option:selected").removeAttr("selected");
                           	   weight_options.find("option[value='yes']").attr("selected","true");                   	  
                           	   }
                              else
                           	   {
                           	  
                           	   weight_options.find("option:selected").removeAttr("selected");
                           	   weight_options.find("option[value='no']").attr("selected","true");                    	     
                           	   }
                                  WeightChange();
         	                    });
